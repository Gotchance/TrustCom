...
Then, since it was important to evaluate an accuracy with any detection method, we also wanted to evaluate the accuracy of detection results of {\it GLASSO} engine.
In general, however, it was difficult to distinguish whether a packet arriving at the darknet was intended for a cyber attack.
Therefore, we established one effective method for the evaluation method.
