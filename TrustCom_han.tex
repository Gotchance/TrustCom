...
To capture these scans, we set up receivers (sensors) in our darknet and captured all the traﬃc arriving at the sensors.
...
%~\cite{Akiyama}
Based on this observation, our earlier method~\cite{Han}, called the {\it GLASSO} engine\footnote{The engine is named after the library of R language ``glasso''~\cite{Friedman_glasso}.}, estimates the cooperation of the source hosts by using a sparse structure learning algorithm called the graphical lasso~\cite{Friedman}.
