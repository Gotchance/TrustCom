...
Also, an IP address of source host is one IPv4 address up to the fourth octet, but in order to reduce the number of source hosts $N$, in this experiment, the IPv4 address up to the second octet was taken as one IP address.
...
In many cases, a survey scanner could be found from HTTP connection and a hostname obtained by reverse lookup of a source host IP address.
